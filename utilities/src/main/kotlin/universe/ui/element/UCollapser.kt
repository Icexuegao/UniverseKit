...
open class UCollapser(
  ...
  fun setDuration(seconds: Float, interp: Interp = Interp.linear): UCollapser {
    this.collapseAction.duration = seconds
    this.collapseAction.interpolation = interp
    return this
  }

  fun setCollapsed(collapsed: Boolp): UCollapser {
